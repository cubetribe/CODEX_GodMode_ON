# Flutter Start Prompt

Use this for Flutter and Dart implementation work.
...
- repository and state-flow refactors
- cross-platform app work that spans mobile, desktop, or web
